...
class SharingLinkedin
{
    ...
    public function __construct()
    {
        $i = func_num_args();
        if ($i != 3) {
            throw new SharingLinkedinException('Invalid arguments. Use REDIRECT_URL, CLIENT_ID and CLIENT_SECRET'.$i);
        }
...
class SharingLinkedinException extends Exception
{
